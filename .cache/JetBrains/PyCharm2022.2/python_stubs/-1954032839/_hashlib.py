...
openssl_md_meth_names = None # (!) real value is "frozenset({'sha512', 'md5', 'blake2b', 'md4', 'sha3_512', 'sha224', 'shake_256', 'blake2s', 'whirlpool', 'sha384', 'sha512_256', 'md5-sha1', 'sha256', 'sm3', 'shake_128', 'sha3_256', 'sha1', 'sha512_224', 'sha3_384', 'sha3_224', 'ripemd160'})"
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f611f33e290>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f611f33e290>, origin='/usr/lib/python3.10/lib-dynload/_hashlib.cpython-310-x86_64-linux-gnu.so')"
